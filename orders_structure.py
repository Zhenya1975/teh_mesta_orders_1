...
iw_39_order_category_distribution = iw_39_2022.groupby(['Заказ','Наименование класса ЕО','Краткий текст','Единица оборудования','Название технического места', 'basis_start_monthname_year', 'basis_start_month', 'Вид_заказа'], as_index=False)[['count']].sum()
